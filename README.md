...
**Count of Failure_status by Season (clustered bar, bottom left)**
...
- The Failure bar extends much further on the Avg_Gear_oil_temp axis than No_failure
...
**Record Count by Month and Failure_status (line chart)**
...
**%GT Record Count by Season and Failure_status (100% stacked horizontal bar)**
